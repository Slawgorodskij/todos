...
export default class TodoAdd extends Component{
    constructor(props){
        ...
        this.handleDescChage = this.handleDescChage.bind(this);
        this.handleImageChage = this.handleImageChage.bind(this);
                ...
                <form onSubmit={this.handleFormSubmit}>
                    <div className="field">
                        ...
                        <div className="control">
                            <input className="input" onChange={this.handleTitleChage}/>
                        </div>
                    </div>
                    <div className="field">
                        <label className="label">Примечание</label>
                        <div className="control">
                            <textarea className="textarea" onChange={this.handleDescChage}/>
                        </div>
                    </div>
                    <div className="field">
                        <div className="file">
